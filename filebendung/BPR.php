<div class="context"><div class="bahan bulet" style="position: absolute; top: 175px; left: 316px;">
          
      </div><table border="1" class="bahan table" style="position: absolute; top: 48px; left: 102px;">
        <thead>
            <tr><th colspan="2">
              <select name="lokasi" class="lokasi">
                                      <option value=" B. Pr. 1 Ki" style="text-align:center;" selected="true"> B. Pr. 1 Ki
                                      </option><option value=" B. Pr. 2 Ka" style="text-align:center;"> B. Pr. 2 Ka
                                      </option><option value=" B. Pr. 2 Ki" style="text-align:center;" selected="true"> B. Pr. 2 Ki
                                      ...
                                      </option><option value=" B. Ka. 1 Ka" style="text-align:center;" selected="true" disabled="true"> B. Ka. 1 Ka
                                      </option><option value=" B. Ka. 2 Ka" style="text-align:center;" disabled="true" selected="true"> B. Ka. 2 Ka
      ...
      </table><div class="bahan bulet" style="position: absolute; top: 176px; left: 608px;">
          
      </div><div class="bahan panah" data-rot="0" style="position: absolute; top: 185px; left: 326px; width: 600px;">
          <div class="popup" style="display: none;">
              <button class="resize">Resize</button>
              <button class="rotate">Rotate</button>
              <button class="remove">Remove</button>
          </div>
      </div><div class="bahan panah" data-rot="45" style="position: absolute; top: 150px; left: 239px; transform: rotate(45deg);">
          <div class="popup" style="display: none;">
              <button class="resize">Resize</button>
              <button class="rotate">Rotate</button>
              <button class="remove">Remove</button>
      ...
      </div><table border="1" class="bahan table" style="position: absolute; top: 290px; left: 860px;">
        <thead>
            <tr><th colspan="2">
              <select name="lokasi" class="lokasi">
      ...
      </table><div class="bahan panah" data-rot="90" style="position: absolute; top: 558px; left: 168px; transform: rotate(90deg); width: 900px;">
          <div class="popup" style="display: none;">
              <button class="resize">Resize</button>
              <button class="rotate">Rotate</button>
              <button class="remove">Remove</button>
          <button>Close</button></div>
      </div><div class="bahan bulet" style="position: absolute; top: 95px; left: 607px;">
          
      </div><div class="bahan panah" data-rot="0" style="position: absolute; top: 103px; left: 570px;">
          <div class="popup">
              <button class="resize">Resize</button>
              <button class="rotate">Rotate</button>
              <button class="remove">Remove</button>
          </div>
      </div><table border="1" class="bahan table" style="position: absolute; top: 58px; left: 418px;">
        <thead>
            <tr><th colspan="2">
              <select name="lokasi" class="lokasi" selected="true" value=" B. Wp. 1 Ki">
                                      <option value=" B. Pr. 1 Ki" style="text-align:center;" selected="true"> B. Pr. 1 Ki
                                      </option><option value=" B. Pr. 2 Ka" style="text-align:center;"> B. Pr. 2 Ka
                                      </option><option value=" B. Pr. 2 Ki" style="text-align:center;"> B. Pr. 2 Ki
                                      </option><option value=" B. Pr. 2 Tg" style="text-align:center;"> B. Pr. 2 Tg
                                      ...
                                      </option><option value=" B. Ka. 5 Ka" style="text-align:center;" selected="true"> B. Ka. 5 Ka
                                      </option><option value=" B. Ka. 6 Ka" style="text-align:center;"> B. Ka. 6 Ka
                                      </option><option value=" B. Ka. 7 Ka" style="text-align:center;"> B. Ka. 7 Ka
                                      </option><option value=" B. Ka. 7 Ki" style="text-align:center;"> B. Ka. 7 Ki
                                      </option><option value=" B. Wp. 1 Ki" style="text-align:center;" selected="true"> B. Wp. 1 Ki
                                      </option><option value=" B. Wp. 2 Ka" style="text-align:center;"> B. Wp. 2 Ka
                                      </option><option value=" B. Wp. 2 Ki" style="text-align:center;"> B. Wp. 2 Ki
                                      </option><option value=" B. Ba. 1 Ki" style="text-align:center;"> B. Ba. 1 Ki
                                      </option><option value=" B. Ba. 1 Tg" style="text-align:center;"> B. Ba. 1 Tg
      ...
      </table><table border="1" class="bahan table" style="position: absolute; top: 58px; left: 668px;">
        <thead>
            <tr><th colspan="2">
              <select name="lokasi" class="lokasi" value=" B. Pr. 2 Ki">
                                      <option value=" B. Pr. 1 Ki" style="text-align:center;" selected="true"> B. Pr. 1 Ki
                                      </option><option value=" B. Pr. 2 Ka" style="text-align:center;"> B. Pr. 2 Ka
                                      </option><option value=" B. Pr. 2 Ki" style="text-align:center;" selected="true"> B. Pr. 2 Ki
                                      </option><option value=" B. Pr. 2 Tg" style="text-align:center;"> B. Pr. 2 Tg
      ...
      </table><table border="1" class="bahan table" style="position: absolute; top: 486px; left: 746px;">
        <thead>
            <tr><th colspan="2">
              <select name="lokasi" class="lokasi">
                                      <option value=" B. Pr. 1 Ki" style="text-align:center;"> B. Pr. 1 Ki
      ...
      </table><div class="bahan bulet" style="position: absolute; top: 524px; left: 609px;">
          
      </div><table border="1" class="bahan table" style="position: absolute; top: 342px; left: 175px;">
        <thead>
            <tr><th colspan="2">
              <select name="lokasi" class="lokasi">
                                      <option value=" B. Pr. 1 Ki" style="text-align:center;"> B. Pr. 1 Ki
      ...
      </table><div class="bahan panah" data-rot="90" style="position: absolute; top: 562px; left: 95px; transform: rotate(90deg); width: 300px;">
          <div class="popup" style="display: none;">
              <button class="resize">Resize</button>
              <button class="rotate">Rotate</button>
              <button class="remove">Remove</button>
          <button>Close</button></div>
      </div><div class="bahan panah" data-rot="0" style="position: absolute; top: 532px; left: 246px; width: 500px;">
          <div class="popup" style="display: none;">
              <button class="resize">Resize</button>
              <button class="rotate">Rotate</button>
              <button class="remove">Remove</button>
          </div>
      </div><table border="1" class="bahan table" style="position: absolute; top: 711px; left: 170px;">
        <thead>
            <tr><th colspan="2">
              <select name="lokasi" class="lokasi">
                                      <option value=" B. Pr. 1 Ki" style="text-align:center;"> B. Pr. 1 Ki
      ...
      </table><div class="bahan panah" data-rot="0" style="position: absolute; top: 1007px; left: 319px; width: 300px;">
          <div class="popup" style="display: none;">
              <button class="resize">Resize</button>
              <button class="rotate">Rotate</button>
              <button class="remove">Remove</button>
          </div>
      </div><table border="1" class="bahan table" style="position: absolute; top: 960px; left: 167px;">
        <thead>
            <tr><th colspan="2">
              <select name="lokasi" class="lokasi">
                                      <option value=" B. Pr. 1 Ki" style="text-align:center;"> B. Pr. 1 Ki
        ...
        </div><table class="bahan table" data-rot="0" style="position: absolute; top: 251px; left: 109px;">
          <thead>
            <tr><th colspan="2">
              <select name="lokasi" class="lokasi">
                                  <option value=" B. Pr. 1 Ki" style="text-align:center;"> B. Pr. 1 Ki
        ...
        </table><div class="bahan panah" data-rot="135" style="position: absolute; top: 218px; left: 238px; transform: rotate(135deg);">

        </div><div class="bahan text" contenteditable="true" data-rot="0" style="position: absolute; top: 151px; left: 655px;">Bpr</div><div class="bahan bulet" data-rot="0" style="position: absolute; top: 179px; left: 1028px; background-color: rgb(61, 12, 237);">

        </div><table class="bahan table" data-rot="0" style="position: absolute; top: 157px; left: 1135px;">
          <thead>
            <tr><th colspan="2">
              <select name="lokasi" class="lokasi">
                                  <option value=" B. Pr. 1 Ki" style="text-align:center;"> B. Pr. 1 Ki
        ...
        </table><div class="bahan panah" data-rot="0" style="position: absolute; top: 187px; left: 1039px;">
